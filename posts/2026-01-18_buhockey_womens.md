...
The most notable feature about Walter Brown - especially compared to Agganis - is the lack of end seating: ALL the seats here are along the sides, and the entrances to the arena are on BU's defend twice end. Each section in the arena has a "lower" and "upper" seating area; the "lower" area has individual seats, and the "upper" area is bench seating. The end with the entrance also has a lot of standing room, which in a sense, is fairly similar to the standing area in [Bridgeport](2026-01-12_bptislanders).
