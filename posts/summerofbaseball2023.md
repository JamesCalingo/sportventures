...
title: "The Summer of Baseball 2023"
subtitle: 
date:
publishDate:
published: false
...
These were mostly posted in the order I visited them that summer (i.e. 2023, as I visited MANY of the teams the year before in a different order) with a few exceptions, as there are - of course - several teams in this list that I've visited since starting this blog (namely Chatham, Nashua, Wareham, Bristol, Danbury, and New Britain). The Pittsfield Suns were also "out of order", as I chose to post them last due to them going dormant in 2024.
...
1. The Futures League added a new team in 2026: a revival of the Lowell Spinners of New York-Penn League fame. I DID have thoughts about visiting during July 4th weekend, but traffic concerns (plus the fact that it was HOT) ended up scuttling the trip - though I did briefly visit their stadium back in 2025 (before it was announced they would be coming back) and [wrote a few thoughts on the place](lelacheurpark).

2. This list does not include the [Winnipesaukee Muskrats](2026-04-11_wpsmuskrats), who had folded before 2023.

3. I am aware of the existence of a fourth league (the Greater Northeast Collegiate Baseball League, which is a member of [The Players League](2026-06-22_shashallywags)). However, as it's currently based out of a single stadium in Maine (and the league's relative "lack of status" seems to be leading to stability issues), I'm not sure if or when I'll be able to get to it. I did TRY to visit this stadium once as I drove past it one time, but an event was going on that I didn't want to deal with (it's in Old Orchard Beach, which is one of Maine's bigger tourist destinations).
