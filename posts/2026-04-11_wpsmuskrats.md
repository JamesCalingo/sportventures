...
However, the story doesn’t QUITE end here. Despite the Swamp Bats and Muskrats splitting a double header, there’s still a little bit of an unsettled business; I have forgotten the EXACT details of it, but there was a chance for either the Muskrats or some other team to make the NECBL postseason - potentially requiring a "makeup" game to be played. I went to Sanford, ME the next day to see the end of a game between the Swamp Bats and the Sanford Mainers (which was suspended from a few days earlier), and since the Mainers won that game, they clinched the playoff berth - thus rendering the makeup game between Winnipesaukee and the Upper Valley Nighthawks (from White River Junction, VT) irrelevant[^1].

Months later, when the NECBL released its 2023 schedule, I looked at it since I was planning to visit all 14 of its teams that summer (protip: don't - some of these teams are HIKES). However, when I counted up the teams, I realized that one was missing, so I went through the list of names, and I found that the Winnipesaukee Muskrats were no longer listed on the NECBL’s website.
