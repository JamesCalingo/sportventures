...
1. Most of the entrances are at the same level as the concourse. However, I couldn't tell from inside, but it seems that the arena is built into a hill, as one entrance (the one I came in from which is attached to the garage) is below concourse level (similar to the entrances at [Prudential Center in Newark](2025-08-28_nysirens)).
...
3. Similar to the [Tsongas Center in Lowell, MA](2025-08-29_bosfleet), there's a premium area along one side of the concourse, but here, it's on one of the "long sides". I THOUGHT this would mean that the concourse was not fully accessible without a premium ticket, but it turns out that wasn't true! A passageway behind this premium area "completes" the full 360, and this part of the concourse has (the arena's obligatory) Chickie's and Pete's.
...
6. There's a real goal horn here, and it's in the rafters near the upper deck. It's not SUPER loud and you'll pretty much know it's coming when the crowd starts cheering, but if you're close enough, you can see the gas used to power it (and sometimes even smell it as well...)
...
In addition, the team was celebrating the recent release of Taylor Swift's "The Life of a Showgirl" - playing nothing but her music/remixes throught the game (including the goal song). No word on which Phantoms player, if any, will have a song written about their stick however[^3]...
...
There are two merch areas on the concourse: A small one near the Tim Hortons, and the main one at the top of the stairs/escalator from the parking garage. While most of what you'll find is standard sports team fare, they did have a few pairs of "gloves" that were interesting (one pair was based on what the mascot typically wears). However, I only bought one thing: a jersey - and I need to talk about it.

The AHL currently has CCM as its jersey manufacturer - a company with a long history in hockey (as they had NHL contracts 20 years ago). Historically, I've found that CCM's replica jerseys are...not good: the logos on them are heat pressed (i.e not stitched on) and the shoulder patches are shockingly low quality (I’ve bought MANY replica and a few authentic CCM jerseys as they used to do CHL jerseys until 2025, and it is INSANE how much better the authentics are - especially on the shoulders)[^4]. HOWEVER...something must have changed between 2022-23 and now, because the jersey I got has MUCH BETTER shoulder patches, and not only that, they're stitched on! Front logo still isn't however...
...
[^4]: I also have a signed, game-worn AHL jersey, which is even nicer quality than the authentics despite being MASSIVE on me even though it’s in the size I normally get (as retail jerseys aren’t made for hockey padding).