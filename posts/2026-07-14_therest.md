...
display: "The Others"
title: "USL: Unvisited"
subtitle: "A quick look at USL teams I didn't get to visit this season"
date:
...
Despite me visiting many of the teams [USL League Two's Metropolitan Division](usl2_overview), I wasn't able to get to _all_ of them, as the remaining teams are kinda awkwardly located and none of them had afternoon games (the only team in the Metropolitan division with afternoon games was [NJ Copa](2026-07-11_njcopa)). However, I feel like in the interest of "completeness", I should talk a little bit about them.
...
Being on Long Island, sadly, makes a trip out here pretty much impossible, and their schedule doesn't help either: there's a baseball team on the island I'd like to visit (i.e. combine the two into one trip for "value"), but the schedules didn't line up (it also doesn't help that the soccer team is by Nassau Coliseum, and the baseball team is somewhere in Suffolk County). It is also due to this distance that a 2027 trip is unlikely (as I can see myself TRYING to make it out to the others next year).
