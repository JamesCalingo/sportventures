---
display: "New York City FC (5/25/25)"
title: "New York City Football Club (Major League Soccer) @ Yankee Stadium (Bronx, NY)"
subtitle: 'I enter what I consider "baseball hell" to watch...soccer?'
date: 13 August 2025
published: true
pinned: false
tags: ["Football", "Association Football/Soccer", "Major League Soccer", "New York", "Yankees", "The Bronx"]
---

_\*This trip occurred on May 25, 2025, and you'll note that it's NOT a baseball game. I was originally just chronicling baseball games with these 2025 writeups, and as such, I was debating whether or not to write about this as it’s a different sport (soccer), but eventually decided to include it - mostly as it’s still a baseball stadium._

The New York Feather Monkey Yankees.

As a Massachusetts native, I grew up not liking the Yankees all that much, so given that I'm currently living in New Jersey (and have been for a while), I’ve never truly known how to deal with them. On the one hand, you have to give them credit: that history is impressive (even if the Red Sox are, more often than not, on the wrong side of it). On the other hand...their magical ability to be slightly above mid at worst when literally EVERY OTHER TEAM IN NORTH AMERICA has had a bad season in the 21st century is downright MADDENING. Most of my friends are Yankee fans, and they’ve never had to suffer through a truly dismal season the way just about everyone else has (the last time the Yankees finished under .500 was the year I was born, so if you know or choose to look it up, you now know my age).
...
I don’t think I’ve seen as many merch stores/stands at ANY sporting event as I did at Yankee Stadium - save for another MLB park I visited later in the year (but more on that will have to wait for now.)

While the store with street access (i.e. the one that is open when nothing’s going on) seems small, there’s a bigger one further in (though it seems to only be for games). Half of the small stands sold the same exact things (i.e. jerseys, hats, and other fun things), but a store on the second level had something rather interesting: clearance merchandise! I was able to take advantage of this to get a few old jerseys (thanks to soccer teams and their propensity for changing their jerseys every year; it's also piqued my interest in returning next year if/when the current away jersey with the monogram rotates out).

For what it’s worth, I also got a special “NYC Parks Green” jersey and a hat with the current NYC monogram, but I didn’t get any logo balls - New York City FC or Yankees.

---

[^1]: For the longest time, the common name for the team was "NYCFC", but apparently the team isn't fond of that.