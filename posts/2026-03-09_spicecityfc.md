...
I already went over the building [not even a month ago](2026-02-15_dbyhattricks), but if you missed it: it's a local sports center which is mainly focused on hockey. The main arena features a large seating area on one side (opposite the arena entrances), "balcony style" seats on the other, and a large lobby-ish area with concessions/merch/an arcade. I did not get to see the mezzanine behind the "balcony sections" last time, but it was more or less accessible this game, so I decided to take a peek, and there's actually a surprising amount of things here!
