...
subtitle: "One venue: Two teams - two years apart (sorta)"
date: 29 August 2025
published: true
pinned: false
---
...
However, this post isn't about UMass Lowell as their season had LONG ended by the time I made THIS visit. Now, let’s talk about the team I did see: the Boston Fleet - and their predecessors[^1].
...
As an aside, I have been to all of these buildings for hockey - most of them multiple times (Worcester and Bentley being the exceptions).
...
That's it! I've caught up with all of my old posts for 2025!

Of course, this is NOWHERE near the end of my adventures. I've got a few places I want to check out coming up (in case the Scranton/Wilkes-Barre "interruption" wasn't an indication of that already), a bunch of old stuff that could probably use a bit of a touch up, plus a few other ideas that don't necessarily involve going to stadiums, so stay tuned for that!

Tomorrow, however, I am going to wrap up a few loose ends regarding some of the things I've posted about so far.

---

[^1]: I’m not going to repeat the history of women’s hockey here - if you want that, it’s in [the New York Sirens post](2025-08-28_nysirens), and it may help with some context for this history.
