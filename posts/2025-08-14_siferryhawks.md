...
- Something I heard about between starting this write up and my actual visit: land. MLB created a list of new specifications for Minor League stadiums alongside the realignment which, for most teams, involved needing to perform intensive renovations. Given that the stadium is sandwiched between the Hudson River and a major roadway, there’s probably not enough room to meet the specs (not to mention trying to get the money to get anything done in New York…). Alao, because of this proximity to the Hudson River, the concourse does not loop around the outfield (there’s a 9/11 memorial just past left that I have yet to visit BTW).
