---
display: "The Amazing Baseball Circus"
title: "Indianapolis Clowns vs. The Party Animals @ Dunkin’ Park (Hartford, CT)"
subtitle: 'The "original" barnstorming baseball team returns'
date: 25 July 2026
...
In 2025, it was announced that through a partnership with the Negro Leagues Baseball Museum (in Kansas City, MO), the Indianapolis Clowns would return to their barnstorming ways as the sixth member of the Banana Ball Championship League, which means...

## SURPRISE! This is another Banana Ball post!
...
Anyway, the plaza was actually pretty small this time (or at least it FELT small), and there was no special K Club area [again](2026-06-12_bananaball_js), so I don't really have that much to say about it. However, it did feature this absolutely amazing entryway:
...
I’ve found that the merch tents at Banana Ball games frequently have items not available online, so I figured I’d at least check in on that (as the Clowns were the only team I hadn't done that for yet). In addition, there was one thing that I saw online that I wanted to "check in" on: hats.

The Banana Ball online store indicates that Indianapolis Clowns player hats are mostly cotton, and the last time I bought a cotton Zephyr hat, it did NOT go over well (Zephyr being the brand that makes hats for many, MANY teams including several of the Banana Ball teams plus every team in the New England and Futures Leagues). However, the Clowns hat I ended up getting from this game is actually polyester (which is what most hats are made of nowadays).

Also, I mentioned back at the [first Banana Ball game I went to this year](2026-04-25_bananaball_ny) that player jerseys were available at that game. As I understand it, each team has at least one player jersey available at games, and for the Clowns, that player is JBJ (again, former Major Leaguer). Given the likelihood of this game being full of Red Sox fans (Hartford being the closest the Clowns get to Boston proper in 2026[^3]), I wasn't sure if they'd still have his jersey by the time I got to the merch tables (as this was the final day they'd be in Hartford). Thankfully, the org had a special "player jersey ordering period" a few months before this game where you could get specific players, so I ended up taking advantage of that and ordering a JBJ jersey online (which arrived a few weeks before this game[^4]).
...
P.S.: I checked, and I'm fairly certain my seat was NOT in the "standard" camera view. If I'm in some of the batter closeups and you are demented enough to look for me:
...
[^1]: Look up Tom Yawkey if you have some time, and find out why I cringe a bit every time I go to a Cape Cod Baseball League game. While you do that, you can also learn about why Bill Russell and Torii Hunter feel the way they do about Boston...

[^2]: I don't know how ticket buying works for lottery folk as I've never done it, but for the K Club, you buy in sections, and then you're assigned a seat closer to the game.
