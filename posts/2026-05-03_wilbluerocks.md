...
As for the stadium itself...it's VERY similar to [Trenton Thunder Ballpark](2025-08-15_trethunder) if I must be honest. Street level entrances to an elevated concourse, a seating bowl with upper and lower sections separated by a small walkway, and a team store on the concourse and INSIDE the ticketed area. However, one thing that separates it from Trenton: a general admission bleacher area high on the third base side (similar to the general admission areas at [Hudson Valley Renegades](2025-08-10_hvrenegades) games). These are the only seats OUTSIDE of the main seating bowl (as in they're the only seats above the main concourse).
