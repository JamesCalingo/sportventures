...
However, here is where things get a little "odd", as there WAS a team in the area prior to 2025: the Brunswick Surfin Turfs (representing the county as a whole). Their social media pages indicate a 2022 establishemnt with their first season of play being 2023; they had the best record in the league that year, but lost their lone playoff game.

The team wasn't quite as good in 2024[^1], but were still able to make the playoffs (where they lost again). Then, in 2025, the Surfin Turfs "split" into two teams in the area - one of them being the Shallotte Shallywags. However...it's possible the term "split" isn't exactly accurate.
...
Yes, this is a high school field, so there's not much to talk about: all there really is are bleachers and a press box. However, I should mention that similar to [Rutgers](2026-03-29_rutgers_batandball), this is a baseball/softball complex with the softball field sharing a gate/concourse with the baseball stadium, there are plastic "chairs" in the section behind home plate (which does not rise as high as the baseline sections due to the press box), and something rather unusual: a MOSTLY normal dirt infield save for the basepaths to first and third base from home, which are grass instead of dirt as shown in the photo below (and as an aside: this isn't the last time I'm going to talk about a field with this specific setup).

![A photo of a baseball field with the first and third base lines featuring grass instead of dirt](/images/2026/0615-shallywags.jpeg)
...
[^1]: There was one game scheduled for the week we were there that year, but it got cancelled, so I wouldn't have been able to see them even if I had known about the team.

[^2]: Assuming the real estate developers building new apartment complexes in the area don't ruin it first...